    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 mt-2 h-[5rem] overflow-hidden rounded-lg">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          {/* Product info */}
          <div className="lg:col-sapn-1 max-auto max-w-2xl px-4 pb-16 lg:pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">25070 Ratings</p>
                  <p className="ml-3 text-indigo-900 hover:text-indigo-500 text-sm font-medium">
                    3890 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          <h1 className="pb-4 text-lg font-semibold">Recent review & update</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">34562 Ratings</p>
                </div>
                <Box className="mt-5">
